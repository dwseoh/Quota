export interface ComponentDefinition {
    ...
    color: string;
    description?: string;
    baseCost?: number; // Base monthly cost in USD
}
...
export const COMPONENT_LIBRARY: ComponentCategory[] = [
    ...
    },
    {
        ...
        components: [
            ...
            { id: "mongodb", name: "MongoDB", icon: logo("mongodb"), color: "#47a248", baseCost: 57 },
            { id: "supabase", name: "Supabase", icon: logo("supabase"), color: "#3ecf8e", baseCost: 25 },
            { id: "firebase", name: "Firebase", icon: logo("firebase"), color: "#ffca28", baseCost: 25 },
            { id: "redis", name: "Redis", icon: logo("redis"), color: "#dc382d", baseCost: 10 },
            { id: "amazondynamodb", name: "DynamoDB", icon: logo("amazondynamodb"), color: "#4053d6", baseCost: 20 },
            { id: "planetscale", name: "PlanetScale", icon: logo("planetscale"), color: "#000000", baseCost: 29 },
        ],
    },
    {
        id: "hosting",
        ...
        components: [
            ...
            { id: "cloudrun", name: "Cloud Run", icon: logo("googlecloud"), color: "#4285f4", baseCost: 15 },
        ],
    },
    {
        id: "ml",
        ...
        components: [
            ...
            { id: "openai", name: "OpenAI API", icon: logo("openai"), color: "#10a37f", baseCost: 100 },
            { id: "anthropic", name: "Anthropic", icon: logo("anthropic"), color: "#d4a574", baseCost: 100 },
        ],
    },
    {
        id: "auth",
        ...
        components: [
            ...
            { id: "cognito", name: "AWS Cognito", icon: logo("amazonaws"), color: "#ff9900", baseCost: 15 },
        ],
    },
    {
        id: "cache",
        ...
        components: [
            ...
            { id: "cloudflare-cdn", name: "Cloudflare", icon: logo("cloudflare"), color: "#f38020", baseCost: 20 },
            { id: "cloudfront", name: "CloudFront", icon: logo("amazonaws"), color: "#ff9900", baseCost: 15 },
    ...
    },
    {
        ...
        components: [
            ...
            { id: "sqs", name: "AWS SQS", icon: logo("amazonsqs"), color: "#ff9900", baseCost: 10 },
            { id: "redis-pubsub", name: "Redis Pub/Sub", icon: logo("redis"), color: "#dc382d", baseCost: 0 },
            { id: "pubsub", name: "Google Pub/Sub", icon: logo("googlecloud"), color: "#4285f4", baseCost: 15 },
        ],
    },
    {
        id: "storage",
        ...
        components: [
            ...
            { id: "azure-blob", name: "Azure Blob", icon: logo("microsoftazure"), color: "#0078d4", baseCost: 6 },
            { id: "cloudflare-r2", name: "Cloudflare R2", icon: logo("cloudflare"), color: "#f38020", baseCost: 3 },
    ...
    },
    {
        ...
        components: [
            ...
            { id: "circleci", name: "CircleCI", icon: logo("circleci"), color: "#343434", baseCost: 15 },
            { id: "jenkins", name: "Jenkins", icon: logo("jenkins"), color: "#d24939", baseCost: 10 },
    ...
    },
    {
        ...
        components: [
            ...
            { id: "newrelic", name: "New Relic", icon: logo("newrelic"), color: "#008c99", baseCost: 25 },
            { id: "prometheus", name: "Prometheus", icon: logo("prometheus"), color: "#e6522c", baseCost: 0 },
            { id: "logrocket", name: "LogRocket", icon: logo("logrocket"), color: "#764abc", baseCost: 99 },
        ],
    },
    {
        id: "search",
